...
<head>
  ...
  #e2f4ff 70%,
  #cfeaff 100%);
      background-attachment: fixed; /* keeps gradient fixed so it "blends" across sections */
    }
    ...
    .snap-section {
      ...
      background: transparent; /* important so body gradient shows through */
    }

    /* optional: hide default scroll bar on some browsers (nice look) */
    .snap-container::-webkit-scrollbar { width: 8px; }
    .snap-container::-webkit-scrollbar-thumb { background: rgba(0,0,0,0.12); border-radius: 9999px; }
    /* DOT INDICATOR */
.dots {
  position: fixed;
  right: 35px;
...
<body class="text-gray-800 font-poppins">
  ...
  <div class="snap-container">
      ...
      <div class="max-w-7xl mx-auto px-6 grid md:grid-cols-2 items-center w-full">
        ...
        <div class="p-6 md:p-20">
          ...
          <div class="text-center md:text-left">
            <a href="#services" class="bg-[#4C9FFF] py-2 px-7 rounded-full text-white inline-flex items-center gap-2 hover:bg-blue-500 transition">
              Pesan Sekarang
        ...
        <div class="hidden md:flex justify-center items-center relative">
          <img src="{{ asset('landing-img/welcome-illus.svg') }}" class="w-4/5 drop-shadow-xl relative z-20 -mt-10" alt="Hero Illustration">
    ...
    <section id="services" class="snap-section flex items-center">
      <div class="max-w-6xl mx-auto px-6 text-center w-full py-12">
        <h2 class="text-3xl font-bold mb-10">Layanan Kami</h2>

        <div class="grid md:grid-cols-3 gap-10">
          <div class="bg-white/60 backdrop-blur p-8 rounded-2xl shadow-md">
...
<script>
    ...
    container.addEventListener('wheel', (e) => {
        ...
        gsap.to(container, {
            duration: 1.0,
            scrollTo: { y: sections[nextIndex].offsetTop },
            ease: "power3.out",
...
dots.forEach(dot => {
  dot.addEventListener('click', () => {
    ...
    gsap.to(container, {
      duration: 1,
      scrollTo: { y: sections[i].offsetTop },
      ease: "power3.out"
    });
  });
});
