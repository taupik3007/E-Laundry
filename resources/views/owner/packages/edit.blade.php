...
@section('title')
    E-Laundry | Edit Paket - {{ $service->lds_name }}
@endsection
...
<div class="row">
    <div class="col-lg-12">
                ...
                <nav aria-label="breadcrumb">
                  <ol class="breadcrumb">
                    <li class="breadcrumb-item">
                      <a class="text-muted text-decoration-none" href="/owner/service">Daftar Layanan</a>
                    </li>
                    <li class="breadcrumb-item">
      ...
      <div class="card">
        ...
        <form action="{{ route('packages.update', [$service->lds_id, $package->ldp_id]) }}" method="POST">
            @csrf
