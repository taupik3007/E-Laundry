                ...
                <div class="col-9">
                  ...
                  <nav aria-label="breadcrumb">
                    ...
                    <li class="breadcrumb-item">
                        <a class="text-muted text-decoration-none" href="/owner/service">Layanan service</a>
                      </li>
                      <li class="breadcrumb-item">
                        <a class="text-muted text-decoration-none" href="/owner/service/create">Tambah Layanan</a>
                      </li>
                      <li class="breadcrumb-item">
                        <a class="text-muted text-decoration-none" href="/owner/service/{id}/edit">Edit Layanan</a>
                      </li>
                    </ol>
        ...
        <div class="card">
            <div class="card-body">
                <div class="mb-5 position-relative">
                    ...
                    <a href="{{ route('packages.create', $service->lds_id) }}" class="btn btn-primary position-absolute top-0 end-0">Tambah Paket</a>
                </div>
