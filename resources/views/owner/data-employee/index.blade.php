            ...
            <div class="card-body">
                ...
                <div class="table-responsive">
                    <table id="file_export" class="table w-100 table-striped table-bordered display text-nowrap">
                        ...
                        <tbody>
                            @foreach($employes as $no => $employee)
                            <tr>
                                <td>{{ $no + 1 }}</td>
                                <td>{{ $employee->usr_name }}</td>
                                <td>{{ $employee->usr_email }}</td>
                                <td>{{ $employee->created_at->format('d M Y') }}</td>
                                <td>
                                    <a href="/employee/customers/{{ $employee->usr_id}}/edit" class="btn btn-primary">Edit</a>
                                    <a href="/employee/customers/{{ $employee->usr_id}}/destroy" class="btn btn-danger" data-confirm-delete="true">Delete</a>
