                        ...
                        <tbody>
                            ...
                            <tr>
                              <td>{{ $no + 1 }}</td>
                                ...
                                <td>
                                  <a href="/owner/pick-up/{{ $order->ord_id}}/detail" class="btn btn-primary">Detail</a>
                                  {{-- <a href="/owner/pick-up/{{ $order->ord_id}}/destroy" class="btn btn-danger" data-confirm-delete="true">Delete</a> --}}
    ...
    <script>
      $(document).ready(function() {
        $('.change-status').on('click', function(e) {
          ...
          $.ajax({
            url: '/owner/pick-up/' + orderId + '/status',
            type: 'POST',
            data: {
              _token: '{{ csrf_token() }}',
