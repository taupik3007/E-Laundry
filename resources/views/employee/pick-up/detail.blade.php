...
<div class="container-fluid">
            ...
            <nav aria-label="breadcrumb">
              <ol class="breadcrumb">
                <li class="breadcrumb-item">
                    <a class="text-muted text-decoration-none" href="/employee/pick-up">Daftar Penjemputan</a>
                  </li>
                <li class="breadcrumb-item">
                ...
                <li class="breadcrumb-item">
                  <a class="text-muted text-decoration-none">History Penjemputan</a>
                </li>
  ...
  <div class="card overflow-visible">
    ...
    <div class="card-body p-4 mt-4">
      ...
      <div class="row">
        <div class="col-md-6"> 
          <p class="mb-1"><strong>Nama Pemesan:</strong> {{ $order->ord_name_user }} </p>
          <p class="mb-1"><strong>No. Telepon:</strong> {{ $order->ord_phone_number }} </p>
          <p class="mb-1"><strong>Tanggal Pemesanan:</strong>{{ \Carbon\Carbon::parse($order->ord_created_at)->translatedFormat('l, d F Y - H:i') }} WIB</p>
          <p class="mb-1"><strong>Status:</strong> {{ $order->ord_status }}
          </p>
        </div>
        <div class="col-md-6">
          <p class="mb-1"><strong>Jenis Layanan:</strong>{{ $order->package->service->lds_name ?? '-' }}</p>
          <p class="mb-1"><strong>Berat Cucian:</strong> {{ $order->ord_total_weight }} kg</p>
          <p class="mb-1"><strong>Total Biaya:</strong> Rp {{ number_format($order->ord_total_price, 0, ',', '.') }} </p>
