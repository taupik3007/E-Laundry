                ...
                <form action="" method="post" enctype="multipart/form-data">
                    ...
                    <div class="card-body">
                        <div class="mb-4 row align-items-center">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="" class="form-control" id="exampleInputText1"
                                    placeholder="Nama Customer" required
                                    oninvalid="this.setCustomValidity('Nama Jurusan Wajib Diisi')"
                        ...
                        <div class="mb-4 row align-items-center">
                            <label for="exampleInputText1" class="form-label col-sm-3 col-form-label">Nomor Telepon</label>
                            <div class="col-sm-9">
                                <input type="text" name="" class="form-control" id="exampleInputText1"
                        ...
                        <div class="mb-4 row align-items-center">
                            ...
                            <div class="col-sm-9">
                                <select class="form-select mr-sm-2" name=""
                                    ...
                                    @foreach ($laundryService as $service)
                        ...
                        <div class="mb-4 row align-items-center">
                            <label for="exampleInputText1" class="form-label col-sm-3 col-form-label">Paket Layanan</label>
                            <div class="col-sm-9">
                                <select class="form-select mr-sm-2" name=""
                                    oninvalid="this.setCustomValidity('Jurusan wajib diisi')"
                                    onchange="this.setCustomValidity('')" required>
                        ...
                        <div class="mb-4 row align-items-center">
                            <label for="exampleInputText1" class="form-label col-sm-3 col-form-label">Qty</label>
                            <div class="col-sm-9">
                                <input type="text" name="" class="form-control" id="exampleInputText1"
                        ...
                        <div class="mb-4 row align-items-center">
                            <label for="exampleInputText1" class="form-label col-sm-3 col-form-label">metode
                                Pengantaran</label>
                            <div class="col-sm-9">
                                <select class="form-select mr-sm-2" name=""
                                    oninvalid="this.setCustomValidity('Jurusan wajib diisi')"
