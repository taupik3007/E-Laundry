                            ...
                            <tr>
                              ...
                              <td>
                                <div class="d-flex align-items-center gap-3">
                                  <a href="/employee/laundry-service/{{ $service->lds_id }}/edit"
                                     class="text-primary"
                                  ...
                                  <a href="/employee/laundry-service/{{ $service->lds_id }}/package"
                                     class="text-warning"
                                     data-bs-toggle="tooltip"
                                     title="Paket">
                                  ...
                                  <a href="/employee/laundry-service/{{ $service->lds_id }}/destroy"
                                     class="text-danger"
