     ...
     <div><!-- ---------------------------------- -->
         ...
         <div class="brand-logo d-flex align-items-center justify-content-between">
             <a href="#" class="text-nowrap logo-img">
                 {{-- <img src="{{ asset('assets/images/logos/logooo.png')}}" class="dark-logo" alt="Logo-Dark" width="150" />
                 <img src="{{ asset('assets/images/logos/logooo.png')}}" class="light-logo" alt="Logo-light" width="150"/> --}}
                 <img id="logo"
