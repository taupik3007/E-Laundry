          ...
          <form action="" method="post" enctype="multipart/form-data">
            ...
            <div class="card-body">
                <div class="mb-4 row align-items-center">
                    ...
                    <div class="col-sm-9">
                      <input type="text" name="" class="form-control" id="exampleInputText1" placeholder="Nama" required oninvalid="this.setCustomValidity('Nama Jurusan Wajib Diisi')" 
                  ...
                  <div class="mb-4 row align-items-center">
                    ...
                    <div class="col-sm-9">
                      <input type="number" name="" class="form-control" id="exampleInputText1" placeholder="No. Telepon" required oninvalid="this.setCustomValidity('Nama Jurusan Wajib Diisi')" 
                      onchange="this.setCustomValidity('')">
                    </div>
                    @error('')
                      <div>error</div>
                  ...
                  <div class="mb-4 row align-items-center">
                    <label for="exampleInputText1" class="form-label col-sm-3 col-form-label">Alamat Penjemputan</label>
                    <div class="col-sm-9">
                      <input type="number" name="" class="form-control" id="exampleInputText1" placeholder="Alamat Penjemputan" required oninvalid="this.setCustomValidity('Nama Jurusan Wajib Diisi')" 
                      onchange="this.setCustomValidity('')">
                    </div>
                    @error('')
                      <div>error</div>
                ...
                <div class="mb-4 row align-items-center">
                  <label for="exampleInputText1" class="form-label col-sm-3 col-form-label">Berat Cucian</label>
                  <div class="col-sm-9">
                    <input type="number" name="" class="form-control" id="exampleInputText1" placeholder="Berat Cucian" required oninvalid="this.setCustomValidity('Nama Jurusan Wajib Diisi')" 
                    onchange="this.setCustomValidity('')">
                  </div>
                  @error('')
                    <div>error</div>
                ...
                <div class="mb-4 row align-items-center">
                  ...
                  <div class="mb-4 row align-items-center">
                    <label for="exampleInputText1" class="form-label col-sm-3 col-form-label">Metode Pembayaran</label>
                    <div class="col-sm-9">
                      <input type="text" name="" class="form-control" id="exampleInputText1" placeholder="Metode Pembayaran" required oninvalid="this.setCustomValidity('Nama Jurusan Wajib Diisi')" 
                      onchange="this.setCustomValidity('')">
                    </div>
                    @error('')
                      <div>error</div>
