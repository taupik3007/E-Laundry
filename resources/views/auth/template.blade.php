                                    ...
                                    <form method="POST" action="{{ route('password.email') }}">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="email" name="email" :value="old('email')" required
                                                autofocus class="form-control" id="exampleInputEmail1"
                                        ...
                                        {{-- <a href="javascript:void(0)" class="btn btn-primary w-100 py-8 mb-3">Forgot
                                            Password</a> --}}
                                        <input type="submit" class="btn btn-primary w-100 py-8 mb-3" value="forgot Password" >
                                        <a href="/login" class="btn bg-primary-subtle text-primary w-100 py-8">Back to
                                            Login</a>
                                    </form>
                                </div>
                            </div>
