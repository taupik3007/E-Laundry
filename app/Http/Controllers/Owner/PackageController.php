...
class PackageController extends Controller
{
    ...
    public function index($serviceId)
    {
        $service = LaundryService::findOrFail($serviceId);
         ...
         return view('owner.packages.index', compact('service', 'packages'));
    }
    ...
    {
        $service = LaundryService::findOrFail($serviceId);
        return view('owner.packages.create', compact('service'));
    }
    ...
    public function store(Request $request, $serviceId)
    {
        ...
        // dd($CreatePackage);
        return redirect()->route('packages.index', $serviceId)->with('success', 'Paket berhasil ditambahkan!');
    }
    ...
    public function edit($serviceId, $packageId)
    {
        ...
        return view('owner.packages.edit', compact('service', 'package'));
    }
    ...
    public function update(Request $request, $serviceId, $packageId)
    {
        ...
        return redirect()->route('packages.index', $serviceId)
